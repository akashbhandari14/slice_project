...
const ProductGallery: React.FC = () => {
  const images: string[] = [
    "/images/single_product_img.webp",
    "/images/product_display_page_img.webp",
    "/images/single_product_img.webp",
    "/images/single_product_img.webp",
    "/images/single_product_img.webp",
    "/images/single_product_img.webp"
      ...
      <div className="side_img w-full px-2">
        <div className="grid grid-cols-6 gap-2 lg:grid-cols-1 lg:gap-3 lg:max-h-[600px] lg:overflow-y-auto">
          {images.map((img, index) => (
            <div
              key={index}
              className={`relative cursor-pointer transition-opacity duration-300 aspect-square ${
                currentIndex === index 
      ...
      <div className="w-full relative">
        <div className="aspect-square relative">
          <img
            ...
            alt="Main product"
            className="main_image rounded-md w-full h-full object-cover"
          />
          
          {/* Navigation container - positioned absolutely with full height */}
          <div className="absolute top-0 left-0 h-full w-full">
            {/* Center container - uses flex to position buttons */}
